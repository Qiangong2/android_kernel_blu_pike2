...
struct sprd_nand_device kington_device_table[] = {
	...
	{0xAA," PN612G8C2TA-B8BE0","2Gb,x08,1.8V"},
	{0xA1,"PN611G8C2TA-B8BI0","1Gb,x08,1.8V"},
...
struct sprd_nand_vendor_param sprd_nand_vendor_param_table[] = {
	...
	{//Kington
		{0x98,0xAA,0x90,0x15,0x76},0x98,0xAA, 
		SZ_K_BLOCK(128),NUM_BLOCK(2048), SZ_K_PAGE(2),SZ_B_SECTOR(512),SZ_B_SPARE(128),BW_08,CYCLES_5,
		{30,15,10},
		{SZ_B_OOB(32),ECC_BITS(8),POS_ECC(18),SZ_ECC(14),POS_INFO(18),SZ_INFO(0)}
	},
	{//Kington
		{0x98,0xA1,0x80,0x15,0x72},0x98,0xA1, 
		SZ_K_BLOCK(128),NUM_BLOCK(1024), SZ_K_PAGE(2),SZ_B_SECTOR(512),SZ_B_SPARE(128),BW_08,CYCLES_5,
		{30,15,10},
		{SZ_B_OOB(32),ECC_BITS(8),POS_ECC(18),SZ_ECC(14),POS_INFO(18),SZ_INFO(0)}
	},
	{
