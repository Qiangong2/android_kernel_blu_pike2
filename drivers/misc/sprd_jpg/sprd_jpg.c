...
static const struct sprd_jpg_cfg_data sharklt8_jpg_data = {
	.version = SHARKLT8,
	.max_freq_level = 4,
...
struct sprd_jpg_cfg_data sharkl_jpg_data = {
	.version = SHARKL,
	.max_freq_level = 4,
	.softreset_reg_offset = 0x4,
	.reset_mask = BIT(6),
...
static const struct sprd_jpg_cfg_data whale2_jpg_data = {
	.version = WHALE2,
	.max_freq_level = 4,
	.softreset_reg_offset = 0x4,
	.reset_mask = BIT(6),
...
static const struct sprd_jpg_cfg_data iwhale2_jpg_data = {
	.version = IWHALE2,
	.max_freq_level = 4,
	.softreset_reg_offset = 0x4,
	.reset_mask = BIT(6),
...
static const struct sprd_jpg_cfg_data sharkl2_jpg_data = {
	.version = SHARKL2,
	.max_freq_level = 4,
	.softreset_reg_offset = 0x4,
	.reset_mask = BIT(6),
...
static const struct of_device_id of_match_table_jpg[] = {
	{.compatible = "sprd,sharklt8-jpg", .data = &sharklt8_jpg_data},
	{.compatible = "sprd,sharkl-jpg", .data = &sharkl_jpg_data},
	{.compatible = "sprd,whale2-jpg", .data = &whale2_jpg_data},
	{.compatible = "sprd,iwhale2-jpg", .data = &iwhale2_jpg_data},
	{.compatible = "sprd,sharkl2-jpg", .data = &sharkl2_jpg_data},
...
static int jpg_parse_dt(struct platform_device *pdev)
{
	...
	for_each_compatible_node(jpg_clk_np, NULL, "sprd,muxed-clock") {
		if (of_property_read_string_index
			...
			continue;
		if (!strcmp(clk_name, "clk_jpg")
		    || !strcmp(clk_name, "clk_jpg0")) {
			pr_info("clk %s\n", clk_name);
